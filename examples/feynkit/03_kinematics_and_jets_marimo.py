...
def _(cos, cosh, fk, sin, sinh):
    ...
    particles = [
        _massless(80.0, 0.20, 0.10),
        _massless(25.0, 0.25, 0.18),
        _massless(35.0, -1.10, 2.40),
    ]
    return (particles,)
...
def _(fk, particles):
    definitions = {
        ...
        "cambridge_aachen": fk.JetDefinition.cambridge_aachen(
            0.6, minimum_pt=5.0
        ),
    ...
    algorithm_constituents = {
        algorithm: [
            ...
            for jet in definition.cluster(particles).jets
        ]
