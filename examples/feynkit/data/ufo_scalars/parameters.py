...
# The tutorial model deliberately contains only parameters used by its scalar
# interactions. Standard-Model compatibility parameters from the larger
# upstream fixture are unnecessary here and would obscure the loader example.
